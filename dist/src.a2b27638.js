...
},{"moment":"node_modules/moment/moment.js"}],"budget-data.json":[function(require,module,exports) {
module.exports = [{
  "season": "10/11",
  "incomings": [{
    "name": "Bebe",
...
},{}],"node_modules/patternomaly/dist/patternomaly.js":[function(require,module,exports) {
var define;
var global = arguments[3];
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
...
var _budgetData = _interopRequireDefault(require("../budget-data"));

var _patternomaly = _interopRequireDefault(require("patternomaly"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var labels = [];
var totalIncomingsData = [];
var totalOutgoingsData = [];
var netSpendData = [];
var revenueData = [];

_budgetData.default.forEach(function (rec) {
...
var patternList = ['plus', 'cross', 'dash', 'cross-dash', 'dot', 'dot-dash', 'disc', 'ring', 'line', 'weave', 'zigzag', 'zigzag-vertical'];
var colorList = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#003f5c', '#2f4b7c', '#665191', '#a05195', '#d45087', '#f95d6a', '#ff7c43', '#ffa600'];
...
var myChart = new _chart.default(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      backgroundColor: _patternomaly.default.draw(patternList[0], colorList[0]),
      borderWidth: 1
    }, {
      label: "Total generated from Outgoings per Season",
      data: totalOutgoingsData,
      backgroundColor: _patternomaly.default.draw(patternList[1], colorList[1]),
      borderWidth: 1
    }, {
      label: "Net Spent per Season",
      backgroundColor: _patternomaly.default.draw(patternList[2], colorList[2]),
      data: netSpendData,
      borderWidth: 1
    }, {
      label: "Total revenue generated per Season",
      data: revenueData,
      backgroundColor: _patternomaly.default.draw(patternList[3], colorList[3]),
      borderWidth: 1
    }]
  },
  options: {
    ...
    tooltips: {
      ...
      callbacks: {
        label: function label(tooltipItems, data) {
          return "".concat(data.datasets[tooltipItems.datasetIndex].label, ": \xA3").concat(tooltipItems.value, "m");
        },
        afterLabel: function afterLabel(tooltipItems, data) {
          var text = '';
          ...
          if (tooltipItems.datasetIndex < 2) {
            ...
            if (tooltipItems.datasetIndex < 1) {
              text += displayDetails(_budgetData.default[tooltipItems.index].incomings);
            } else {
              text += displayDetails(_budgetData.default[tooltipItems.index].outgoings);
            }
          }
...
function displayDetails(players) {
  ...
  players.forEach(function (player) {
    text += "".concat(player.name, ": \xA3").concat(player.price, "m \n");
  });
  return text;
}
},{"./styles.css":"src/styles.css","chart.js":"node_modules/chart.js/dist/Chart.js","../budget-data":"budget-data.json","patternomaly":"node_modules/patternomaly/dist/patternomaly.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
